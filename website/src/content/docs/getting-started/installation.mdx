...
3. Generate `.github/workflows/deploy.yml` with placeholders replaced
4. Display required GitHub Secrets and Variables
...
This shows your local configuration, checks that the workflow file exists, and lists required GitHub Secrets/Variables. Credentials (SSH, FTP, Git) are configured via GitHub Secrets — the check command does not validate them locally.
