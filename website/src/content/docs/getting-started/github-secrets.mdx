...
:::note
The same private key must authenticate to both Netsons (SSH) and GitHub (git clone). If you use separate keys, you need a more complex SSH config — using one key for both is simpler.
:::
