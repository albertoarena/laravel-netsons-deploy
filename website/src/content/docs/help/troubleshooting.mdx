...
2. Regenerate your workflow to include SSH agent forwarding (added in **v1.7.0**):
   ...
   ```
3. Verify the Netsons server allows agent forwarding (`AllowAgentForwarding yes` — this is the default on most servers)

See [Private Repository Setup](/laravel-netsons-deploy/getting-started/github-secrets/#private-repository-setup-git-strategy) for full details.
