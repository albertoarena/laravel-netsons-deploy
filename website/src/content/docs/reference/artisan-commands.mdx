...
2. Auto-detects env variables from `.env.example` (secret-backed and static) and presents them with multiselect
3. Reads `netsons-deploy.json` for env variables, build vars, custom commands, and notifications
